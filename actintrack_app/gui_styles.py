...
COLOR_EXPLORER_DROP_TARGET = "#243040"
COLOR_EXPLORER_DROP_TARGET_OUTLINE = "#4a7fa3"
...
STYLE_WORKBENCH_ACTION_BUTTON = (
    ...
    "}"
    f"QPushButton#{WORKBENCH_ACTION_BUTTON_OBJECT_NAME}:checked {{"
    f"  background-color: {COLOR_CONTROL_BACKGROUND_HOVER};"
